...
export default function PublishForm({ userId }: PublishFormProps) {
  const { 
    newForm, 
    publishFormAction, 
  ...
  const handlePublishForm = async () => {
    ...
    try {
      // Use the simplified publishFormAction from context
                ...
                {!isPublished ? (
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      className="h-12 px-4"
                      onClick={() => toast.info('Gerenciamento de status em desenvolvimento')}
                    >
                    ...
                    <Button
                      variant="outline"
                      className="h-12 px-4"
                      onClick={() => toast.info('Despublicação em desenvolvimento')}
                    >
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4 border-t">
              ...
              <Button 
                onClick={() => {
                  toast.success('Configurações salvas! (em desenvolvimento)');
